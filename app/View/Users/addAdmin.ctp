...
<?php echo $this->Form->create('User');?>
    <fieldset>
        <legend><?php echo __('Crear administrador'); ?></legend>
        ...
        echo $this->Form->input('role', array(
            'options' => array('Admin_ORI' => 'Admin_ORI', 'Admin_SEC' => 'Admin_SEC')
        ));
		...
		echo $this->Form->submit('Añadir administrador', array('class' => 'form-submit',  'title' => 'Click para añadir') );
?>
    </fieldset>
